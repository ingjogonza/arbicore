...
import { Key, Lock, CheckCircle, Info, Loader2 } from "lucide-react";
			...
			<Card className="w-full max-w-lg p-4 md:p-8">
				<div className="mb-6">
					...
					<p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
						Enter your API keys to enable automated trading execution.
					</p>
				</div>
				...
				{account.apiConnected ? (
					<div className="space-y-4">
						<Alert variant="success" icon={<CheckCircle size={16} />}>
							...
							<p className="mt-1">
								Your Binance account is linked and ready for automated trading.
							</p>
						</Alert>
					...
					<div className="space-y-5">
						...
						<label className="flex items-start gap-3 cursor-pointer">
							...
							<div>
								<p className="text-sm text-slate-700 dark:text-slate-300">
									I confirm my API keys do{" "}
									<span className="font-semibold">NOT</span> have withdrawal
									permissions enabled.
								</p>
						...
						<Alert variant="info" icon={<Info size={16} />}>
							<span className="font-medium">Security Note:</span> You can revoke
							API access from your Binance account at any time. We recommend
						...
						<div className="flex gap-3 pt-2">
							<Button
								...
								disabled={!apiKey || !secretKey || !confirmed || loading}
								className="flex-1"
							>
								{loading ? (
